...
gaas_junction = Junction(kind='2D', T=300,  A=1,n1=1,n2=2,R_series=0.000,R_shunt=1e14, j01=6E-18, j02=1E-14,jsc=150) 
ingap_junction = Junction(kind='2D', T=300,  A=1,n1=1,n2=2,R_series=0.000,R_shunt=1e14, j01=6E-25, j02=1E-14,jsc=150) 

my_solar_cell = SolarCell([ingap_junction,gaas_junction],T=300, R_series=0.0, area=1)
