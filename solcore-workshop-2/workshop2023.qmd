...
[Click here](course_instructions.qmd) for course instructions on the day.

[Click here](Workshop_all_slides.pdf) to view all the presentation slides.

## Installation instructions

If you are familiar with Python/have a working installation (Python >= 3.7, <= 3.11),
...
1 - 5 pm. [Click here](schedule.qmd) for full schedule (subject to change).

_Location:_ F10 June Griffith M10 (K-F10-M10), UNSW Sydney
